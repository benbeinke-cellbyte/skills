...
- **[grill-with-docs](./grill-with-docs/SKILL.md)**: Structured-Q&A grilling that sharpens terminology and updates `CONTEXT.md` and ADRs inline.
...
- **[implement](./implement/SKILL.md)**: Dispatch one fresh implementation owner per ticket, schedule blockers, choose models, integrate commits, and verify.
